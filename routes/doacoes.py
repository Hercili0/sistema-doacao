...
@doacoes_bp.route('/excluir/<int:item_id>', methods=['GET', 'POST'], endpoint='excluir')
@doacoes_bp.route('/deletar_doacao/<int:item_id>', methods=['GET', 'POST'], endpoint='deletar_doacao')
@doacoes_bp.route('/deletar/<int:item_id>', methods=['GET', 'POST'], endpoint='deletar')
@login_required
def excluir(item_id):
    item = Item.query.get_or_404(item_id)
